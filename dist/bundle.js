...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsAppRoot = __webpack_require__(164);

	var _componentsAppRoot2 = _interopRequireDefault(_componentsAppRoot);

	var _actionsStockActions = __webpack_require__(167);

	var _actionsStockActions2 = _interopRequireDefault(_actionsStockActions);
	...
	var App = (function () {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render(element) {
	      ...
	      var appRootElement = _react2['default'].createElement(_componentsAppRoot2['default'], {
	        state: this.state
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _StockList = __webpack_require__(165);
	    ...
	    _createClass(AppRoot, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(_StockList2['default'], { items: this.props.state.items })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _StockListItem = __webpack_require__(166);
	...
	var StockList = (function (_React$Component) {
	    ...
	    */
	    ...
	    function StockList() {
	        ...
	        _get(Object.getPrototypeOf(StockList.prototype), 'constructor', this).call(this);

	        this.socket = io();
	        this.socket.on('stock', function (items) {
	            return _this._update(items);
	        });
	    }
	    ...
	    */
	    ...
	    _createClass(StockList, [{
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    this.props.items.map(function (item, key) {
	                        return _react2['default'].createElement(_StockListItem2['default'], { key: key, item: item });
	                    })
	                )
	            );
	        }
	        ...
	        key: '_update',
	        value: function _update(items) {
	            var _this2 = this;

	            items.forEach(function (i) {
	                return _this2.props.items.push(i);
	            });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StockListItem = (function (_React$Component) {
	    _inherits(StockListItem, _React$Component);

	    function StockListItem() {
	        _classCallCheck(this, StockListItem);

	        _get(Object.getPrototypeOf(StockListItem.prototype), "constructor", this).apply(this, arguments);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dispatcherAppDispatcher = __webpack_require__(168);

	var _dispatcherAppDispatcher2 = _interopRequireDefault(_dispatcherAppDispatcher);

	var _constantsStockConstants = __webpack_require__(172);

	var _constantsStockConstants2 = _interopRequireDefault(_constantsStockConstants);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StockConstants = (0, _keymirror2['default'])({
	  STOCK_CREATE: null,
	  STOCK_DESTROY: null,
	  STOCK_DESTROY_COMPLETED: null,
	  STOCK_UPDATE_PRICE: null
	});

	exports['default'] = StockConstants;
	module.exports = exports['default'];
